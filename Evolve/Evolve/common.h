...
ѕри работе смешанного алгоритм в зависимости от параметра смешивани€ итерации могут выполн€тьс€
либо с использованием глобальных характеристик интервала, либо - локальных.
*/
enum IterationType
{
	///»тераци€ выполн€етс€ по правилам глобального поиска
	Global,
	///»тераци€ выполн€етс€ по правилам локального поиска
	Local
};
